...
public class OrderMasterRepositoryTest {
    ...
    public void deleteByOrderId(){
        orderMasterRepository.deleteByOrderId("1111");
    }

    @Test
    public void findAllByBuyerOpenidAndPayStatusAndOrderStatusTest(){
        String openid = "openidid-123";
        List<OrderMaster> orderMastersList = orderMasterRepository.findAllByBuyerOpenidAndPayStatusAndOrderStatus(openid,0,0);
        System.out.println("orderMasterList: " + orderMastersList);
    }
