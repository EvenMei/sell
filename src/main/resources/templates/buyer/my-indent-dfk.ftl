		...
		<div class="zjzz-buylist-wear">
			...
			<div class="zjzz-buylist-mid">
				...
				<div class="zjzz-buylist-m1">
					...
					<#list waitToPayList as orderDTO>
					...
					<div class="zjzz-buylist-goods1">
						...
						<div class="zjzz-buylist-det">
							<img src="${orderDetail.getProductIcon()}"/>
							<div class="zjzz-buylist-gdetail">
								<span class="zjzz-buylist-gtit1">${orderDetail.getProductName()}</span>
								<span class="zjzz-buylist-gmoney">
									<i class="zjzz-buylist-gm1">￥ ${orderDetail.getProductPrice()}</i>
									<i class="zjzz-buylist-gm2">x ${orderDetail.getProductQuantity()}</i>
								</span>
							</div>
						</div>
						</#list>
						...
						<span class="zjzz-buylist-goodsm">
							...
							<i>应付总额：<i class="zjzz-buylist-gm4">￥${orderDTO.getOrderAmount()}</i></i>
						</span>
